...
//
// Настройки алгоритма:
// 		Наименование			Статьи ДДС Объединение заявок
...
#Область Алгоритм_объединения_заявок_по_статьям_ДДС
...
Если НЕ ОбъектОбработки.ЭтоГруппа Тогда
	КлючиПоиска.Вставить("ВидДвижения", ОбъектОбработки.ВидДвижения);
	МетодыСравнения.Вставить("ВидДвижения", "=");
КонецЕсли;
