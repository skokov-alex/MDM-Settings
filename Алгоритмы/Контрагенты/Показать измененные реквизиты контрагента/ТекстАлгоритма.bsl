...
//
// Описание алгоритма:
// 		Алгоритм просмотра измененных реквизитов по контрагентам.
...
//
// Настройки алгоритма:
// 		Наименование			Показать измененные реквизиты контрагента
...
// 		"Получить значения реквизитов контрагента" (имя параметра ПолучитьЗначения)
//
...
#Область Алгоритм_просмотра_измененных_реквизитов_Контрагентов
...
Иначе
	...
	ДанныеОбъектаОригинального = нсиАлгоритмыОбработкиДанныхЗаявокСервер.ВыполнитьАлгоритм(
			ПараметрыТекущегоАлгоритма.ПолучитьЗначения, ИзменяемыеОбъекты[0].Объект, СтруктураРеквизитов);
	...
	Для Каждого ПроверяемыйРеквизит Из СтруктураРеквизитов Цикл
		...
		// Если оба реквизита не заполнены, тогда их не выводим в сравнение
		Если НЕ ЗначениеЗаполнено(ЗначениеРеквизитаОригинального)
			И НЕ ЗначениеЗаполнено(ЗначениеРеквизитаИзмененного) Тогда
			Продолжить;
		КонецЕсли;
